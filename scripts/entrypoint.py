...
if war_exists():
    ...
    print('Error: FormVu WAR file is missing.')
    print('Please mount your FormVu Microservice, details can be found at the following link.')
    print('https://support.idrsolutions.com/formvu/tutorials/cloud/docker/')
    exit(1)
